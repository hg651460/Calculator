...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonRandom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String displayRand = String.valueOf(n);
                newNumber.setText(displayRand);
            }
        });


        Button xPowY = (Button) findViewById(R.id.xPOWy);
        ...
        buttonMplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String value1 = result.getText().toString();
                result.getText().clear();
                if(value1.length() == 0) {
                    String display = String.valueOf(memorySum);
                    result.setText(display.toString());
                }
                else {
                    try {
                        Double doubleValue1 = Double.valueOf(value1);
                        memorySum += doubleValue1;
                        String display = String.valueOf(memorySum);
                        result.setText(display.toString());
                        newNumber.setText("");
                        operand1 = null;
    ...
    private void performOperation(Double value, String operation) {
        ...
        ///division with Zero will display Error message
        if (pendingOperation.equals("/") && operand1 == 0.0) {
            result.setText("Error");
          //  pendingOperation = "";
            displayOperation.setText("");
            newNumber.setText("");
        }
        //else set the correct result
        else {
